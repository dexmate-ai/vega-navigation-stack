...
private:
    ...
    rclcpp::Subscription<joy_command_mapper::msg::RobotCommand>::SharedPtr joy_command_sub_;
    ...
    inline void JoyCommandCallBack(const joy_command_mapper::msg::RobotCommand::SharedPtr msg) {
        if (msg->clear_cloud) {
            is_reset_env_ = true;
        }
    } 
