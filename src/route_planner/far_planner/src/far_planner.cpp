...
void FARMaster::Init() {
  ...
  joy_command_sub_    = nh_->create_subscription<joy_command_mapper::msg::RobotCommand>("/robot_command", 5, std::bind(&FARMaster::JoyCommandCallBack, this, std::placeholders::_1));
